...
import { getOpeningStatus, type HoursSchedule, type OpeningStatus, type WeeklyHours } from "./opening-hours";
...
type Pick = {
  ...
  caveat?: string;
  opens?: string;
  hours?: WeeklyHours | HoursSchedule;
  level?: string;
  coffeeFocus?: string;
  beans?: string;
  format?: string;
...
const picks: Pick[] = [
  ...
  { name: "GERTRUDHOF", priority: "Strong pick", section: "eat", area: "Kreis 3", get: "Start with the Original Cordon bleu—pork or veal, mini or normal—and add rösti separately.", why: "A small neighborhood Swiss Beizli with a huge, unusually specific Cordon bleu menu.", time: "2–3h", cost: "CHF CHF", tags: ["hungry"], opens: "Tue–Fri 11:30–14:00 + 17:30–23:00 · Sat 17:30 · Sun 16:00", hours: { 2: [["11:30", "14:00"], ["17:30", "23:00"]], 3: [["11:30", "14:00"], ["17:30", "23:00"]], 4: [["11:30", "14:00"], ["17:30", "23:00"]], 5: [["11:30", "14:00"], ["17:30", "23:00"]], 6: [["17:30", "23:00"]], 0: [["16:00", "22:00"]] }, format: "Casual sit-down · takeaway available", reservation: "Reserve for dinner", menuItems: ["TOP — Original: ham · Gruyère · raclette", "Glarner: ham · Maggi · Schabziger · raclette", "Berner: ham · bacon · fried onions · raclette", "Side — rösti (ordered separately)"], menuUrl: "https://www.gertrudhof.ch/essen_trinken/", caveat: "Cordon bleus take about 25–35 minutes and do not include a side. Takeaway can be ordered by phone.", maps: "https://www.google.com/maps/search/?api=1&query=Gertrudhof%20Z%C3%BCrich" },
  { name: "ZUNFTHAUS ZUR WAAG", priority: "Strong pick", section: "eat", area: "Münsterhof", get: "Kalbsgeschnetzeltes ‘Zürcher Art’ with butter rösti; choose with or without veal kidneys.", why: "The proper sit-down version of Zürich’s defining main dish in a historic guild house.", time: "2–3h", cost: "CHF CHF", tags: ["hungry", "2–3h"], opens: "Mon–Sat 11:30–14:00 + 18:00–22:00", hours: { weekly: { 1: [["11:30", "14:00"], ["18:00", "22:00"]], 2: [["11:30", "14:00"], ["18:00", "22:00"]], 3: [["11:30", "14:00"], ["18:00", "22:00"]], 4: [["11:30", "14:00"], ["18:00", "22:00"]], 5: [["11:30", "14:00"], ["18:00", "22:00"]], 6: [["11:30", "14:00"], ["18:00", "22:00"]] }, closedDates: ["2026-05-01", "2026-05-25", "2026-07-20", "2026-07-21", "2026-07-22", "2026-07-23", "2026-07-24", "2026-07-25", "2026-07-26", "2026-07-27", "2026-07-28", "2026-07-29", "2026-07-30", "2026-07-31", "2026-08-01", "2026-08-02", "2026-08-03", "2026-08-04", "2026-08-05", "2026-08-06", "2026-08-07", "2026-08-08", "2026-08-09"] }, format: "Traditional sit-down · table service", reservation: "Reserve ahead", menuItems: ["TOP — Kalbsgeschnetzeltes ‘Zürcher Art’ · butter rösti · with/without veal kidneys", "Also confirmed — veal Wiener schnitzel · potato-cucumber salad · lingonberries", "Dessert — chocolate mousse by Marcel Chardon"], menuUrl: "https://www.zunfthaus-zur-waag.ch/menu", maps: "https://www.google.com/maps/search/?api=1&query=Zunfthaus%20zur%20Waag%20Z%C3%BCrich" },
  { name: "MIT&OHNE", priority: "Strong pick", section: "eat", area: "Zürich HB / Lochergut", get: "Yaprak Steak Döner; choose the toppings and sauce you actually want at the counter.", why: "A high-quality non-Swiss quick eat that fits the walk-around-and-sample style better than another long meal.", time: "30m", cost: "CHF CHF", tags: ["hungry", "1h", "tired", "work", "sunday", "street"], opens: "HB 09:00 daily · until 23:30 Mon–Thu/Sun, midnight Fri/Sat", hours: { 0: [["09:00", "23:30"]], 1: [["09:00", "23:30"]], 2: [["09:00", "23:30"]], 3: [["09:00", "23:30"]], 4: [["09:00", "23:30"]], 5: [["09:00", "24:00"]], 6: [["09:00", "24:00"]] }, format: "Fast casual · takeaway", reservation: "No reservations taken", menuItems: ["TOP — Yaprak Steak Döner (Swiss beef)", "Also confirmed — Chicken Döner", "Meatless — Planted Chicken Kebab"], menuUrl: "https://www.mitundohne.com/", caveat: "This status is for the HB branch. Lochergut has different hours; toppings are customizable—order rather than rely on a fixed build.", maps: "https://www.google.com/maps/search/?api=1&query=mit%26ohne%20Kebab%20Z%C3%BCrich%20HB" },
  { name: "SPRÜNGLI", priority: "Strong pick", section: "eat", area: "Paradeplatz", get: "Build a small mixed box of Luxemburgerli and eat them fresh.", why: "A quick, low-commitment Zürich sweet stop that fits naturally into a walk through the center.", time: "30m", cost: "CHF", tags: ["1h", "tired", "rain", "street"], opens: "Paradeplatz shop 07:30 weekdays · 08:30 Sat · closed Sun", hours: { 1: [["07:30", "18:30"]], 2: [["07:30", "18:30"]], 3: [["07:30", "18:30"]], 4: [["07:30", "18:30"]], 5: [["07:30", "18:30"]], 6: [["08:30", "18:00"]] }, format: "Counter shop · takeaway", reservation: "No reservation", menuItems: ["TOP MIX — pistachio · lemon · caramel fleur de sel", "Also confirmed — raspberry deluxe · hazelnut · bourbon vanilla · chocolate", "Contains alcohol — Champagne Rosé"], menuUrl: "https://www.spruengli.ch/de/luxemburgerli-sorten.html", caveat: "This status is for the Paradeplatz shop; the café remains open on Sunday and has slightly different Saturday hours.", maps: "https://www.google.com/maps/search/?api=1&query=Confiserie%20Spr%C3%BCngli%20Paradeplatz%20Z%C3%BCrich" },
  ...
  { name: "MUSEUM FÜR GESTALTUNG", priority: "Must", section: "design", area: "Ausstellungsstrasse / Toni-Areal", get: "Pick the location by its current exhibitions.", why: "The city’s clearest design priority: visual communication, objects, and Swiss graphic culture.", time: "2–3h", cost: "CHF CHF", tags: ["design", "rain", "2–3h"], opens: "Tue–Sun 10:00–17:00 · Thu until 20:00 · closed Mon", hours: { 0: [["10:00", "17:00"]], 2: [["10:00", "17:00"]], 3: [["10:00", "17:00"]], 4: [["10:00", "20:00"]], 5: [["10:00", "17:00"]], 6: [["10:00", "17:00"]] }, caveat: "Both museum locations share these regular hours; special events and holidays can differ.", maps: "https://www.google.com/maps/search/?api=1&query=Museum%20f%C3%BCr%20Gestaltung%20Z%C3%BCrich" },
  { name: "PAVILLON LE CORBUSIER", priority: "Strong pick", section: "design", area: "Seefeld", get: "See the pavilion, then continue along the lakefront.", why: "A compact architecture destination that turns naturally into a sunny neighborhood walk.", time: "2–3h", cost: "CHF CHF", tags: ["design", "sunny", "2–3h", "wander"], opens: "2026 season 17 Apr–29 Nov · Tue–Sun 12:00–18:00 · Thu until 20:00", hours: { weekly: { 0: [["12:00", "18:00"]], 2: [["12:00", "18:00"]], 3: [["12:00", "18:00"]], 4: [["12:00", "20:00"]], 5: [["12:00", "18:00"]], 6: [["12:00", "18:00"]] }, validFrom: "2026-04-17", validThrough: "2026-11-29", closedDates: ["2026-05-01", "2026-08-01", "2026-09-14"] }, caveat: "The building is viewable from outside year-round; this status covers museum admission during the 2026 season.", maps: "https://www.google.com/maps/search/?api=1&query=Pavillon%20Le%20Corbusier%20Z%C3%BCrich" },
